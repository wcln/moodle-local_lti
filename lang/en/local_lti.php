...
$string['error_rendering_book'] = 'An error occurred while rendering the LTI book. The exception is: \'{$a}\'.';
$string['error_rendering_page'] = 'An error occurred while rendering the LTI page. The exception is: \'{$a}\'.';
